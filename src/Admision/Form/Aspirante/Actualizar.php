...
class Admision_Form_Aspirante_Actualizar extends Gatuf_Form {
	private $aspirante;
	private $convocatoria;
	public function initFields($extra=array()) {
		$this->aspirante = $extra['aspirante'];
		
		$this->convocatoria = $this->aspirante->get_aspiracion()->get_convocatoria();
		...
		$this->fields['aspiracion'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'initial' => $this->aspirante->aspiracion,
				'choices' => $choices_asp,
		...
		$this->fields['nombre'] = new Gatuf_Form_Field_Varchar (
			array (
				'required' => true,
				'label' => 'Nombre',
				'help_text' => 'Los nombres del aspirante',
				'initial' => $this->aspirante->nombre,
				'max_length' => 69,
				'widget_attrs' => array (
					'maxlength' => 69,
					'size' => 25,
		...
		$this->fields['apellido'] = new Gatuf_Form_Field_Varchar (
			array (
				'required' => true,
				'label' => 'Apellido',
				'help_text' => 'Los apellidos del aspirante',
				'initial' => $this->aspirante->apellido,
				'max_length' => 139,
				'widget_attrs' => array (
					'maxlength' => 139,
					'size' => 35,
		...
		$this->fields['nacimiento'] = new Gatuf_Form_Field_Date (
			array (
				...
				'help_text' => '',
				'initial' => implode('/', array_reverse(explode('-', $this->aspirante->nacimiento))),
		...
		$this->fields['pais_nacimiento'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->pais_nacimiento, /* México preseleccionado */
		...
		$this->fields['estado_nacimiento'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->estado_nacimiento,
		...
		$this->fields['lugar_nacimiento'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->lugar_nacimiento,
				'max_length' => 119,
				'widget_attrs' => array (
					'maxlength' => 119,
					/* 'size' => 30, */
		...
		$this->fields['nacionalidad'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'label' => 'Nacionalidad',
				'help_text' => '',
				'initial' => $this->aspirante->nacionalidad, /* México preseleccionado */
				'choices' => $choices_paises,
				'widget' => 'Gatuf_Form_Widget_SelectInput',
		));
		...
		$this->fields['estado_civil'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'label' => 'Estado civil',
				'help_text' => '',
				'initial' => $this->aspirante->estado_civil,
		...
		$this->fields['curp'] = new Gatuf_Form_Field_Varchar (
			array (
				'required' => true,
				'label' => 'CURP',
				'help_text' => 'La Clave Única de Registro de Población del aspirante',
				'initial' => $this->aspirante->curp,
				'max_length' => 24,
				'widget_attrs' => array (
					'maxlength' => 24,
					'size' => 30,
		...
		$this->fields['domicilio'] = new Gatuf_Form_Field_Varchar (
			array (
				'required' => true,
				'label' => 'Domicilio',
				'help_text' => 'Calle y número. En caso de contar con número interior, agreguelo aquí',
				'initial' => $this->aspirante->domicilio,
				'max_length' => 249,
				'widget_attrs' => array (
					'maxlength' => 249,
					'size' => 70,
		...
		$sql = new Gatuf_SQL ('codigo=%s', $cp->codigo);
		
		$choices_cp = array ();
		foreach (Gatuf::factory ('CP_CP')->getList (array ('filter' => $sql->gen())) as $colonia) {
			$choices_cp[$colonia->localidad] = $colonia->id;
		}
		...
		$this->fields['numero_local'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->numero_local,
				'max_length' => 20,
				'widget_attrs' => array (
					'maxlength' => 20,
					/* 'size' => 30, */
		...
		$this->fields['numero_celular'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->numero_celular,
				'max_length' => 20,
				'widget_attrs' => array (
					'maxlength' => 20,
					/* 'size' => 30, */
		...
		$this->fields['trabaja'] = new Gatuf_Form_Field_Boolean (
			array (
				'required' => true,
				'label' => '¿Trabajas?',
				'help_text' => $this->aspirante->trabaja,
				'initial' => false,
		...
		$this->fields['discapacidad'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->discapacidad,
				'choices' => $choices_dis,
				'choices_other' => true,
		...
		$this->fields['sanguineo_rh'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->sanguineo_rh,
		...
		$this->fields['escuela'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->escuela,
				'max_length' => 299,
				'widget_attrs' => array (
					'maxlength' => 299,
					'size' => 70,
		...
		$this->fields['promedio'] = new Gatuf_Form_Field_Float (
			array (
				...
				'label' => 'Promedio',
				'help_text' => '',
				'initial' => $this->aspirante->promedio,
				'widget_attrs' => array (
					'size' => 10,
				),
		));
		...
		$this->fields['escuela_colonia'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->escuela_colonia,
				'max_length' => 199,
				'widget_attrs' => array (
					'maxlength' => 199,
					/* 'size' => 30, */
		...
		$this->fields['escuela_municipio'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->escuela_municipio,
		...
		$this->fields['escuela_tipo'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->escuela_tipo,
				'choices' => $choices_te,
		...
		$this->fields['tipo_prepa'] = new Gatuf_Form_Field_Integer (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->tipo_prepa,
				'choices' => $choices_tp,
				'widget' => 'Gatuf_Form_Widget_RadioInput',
		));
		...
		$this->fields['lic_previa'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'help_text' => '',
				'initial' => $this->aspirante->lic_previa,
				'choices' => array ('No' => 'No'),
				'choices_other' => true,
		...
		$this->fields['emergencia_nombre'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->emergencia_nombre,
				'help_text' => '',
				'max_length' => 100,
				'widget_attrs' => array (
					'maxlength' => 100,
		...
		$this->fields['emergencia_local'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->emergencia_local,
				'help_text' => '',
				'max_length' => 10,
				'widget_attrs' => array (
					'maxlength' => 10,
		...
		$this->fields['emergencia_celular'] = new Gatuf_Form_Field_Varchar (
			array (
				...
				'initial' => $this->aspirante->emergencia_celular,
				'help_text' => '',
				'max_length' => 10,
				'widget_attrs' => array (
					'maxlength' => 10,
	...
	public function clean_curp () {
		if (strlen (trim ($this->cleaned_data['curp'])) != 18) {
			throw new Gatuf_Form_Invalid ('El curp debe ser de 18 caracteres exactamente');
		}
	...
	public function clean_emergencia_local () {
		...
		if (!preg_match ('/^[0-9]*$/', $limpio)) {
			throw new Gatuf_Form_Invalid ('El teléfono de casa para el contacto de emergencia sólo puede estar formado por dígitos');
		}
	...
	public function clean_emergencia_celular () {
		...
		if (!preg_match ('/^[0-9]*$/', $limpio)) {
			throw new Gatuf_Form_Invalid ('El teléfono celular para el contacto de emergencia sólo puede estar formado por dígitos');
		}
	...
	public function clean () {
		...
		if ($pais_nacido == 141) { /* México */
			...
			if ($estado_nacido == 0) {
				throw new Gatuf_Form_Invalid ('Tienes que seleccionar un estado de nacimiento');
			}
		} else {
		...
		if ($casa == '' && $cel == '') {
			throw new Gatuf_Form_Invalid ('Debe proporcionar al menos un número local o celular para contacto');
		}
		...
		if ($casa == '' && $cel == '') {
			throw new Gatuf_Form_Invalid ('Debe proporcionar al menos un número local o celular para el contacto de emergencia');
		}
		...
		foreach ($aspis as $aspi) {
			...
			if ($conv->convocatoria == $this->convocatoria->id && $aspi->id != $this->aspirante->id) {
	...
	public function save ($commit = true) {
		if ($this->cleaned_data['aspiracion'] != $this->aspirante->aspiracion) {
			Gatuf_Log::info (sprintf ('Se acaba de actualizar la aspiración de carrera del aspirante %s', $this->aspirante->id));
		}
		$this->aspirante->setFromFormData ($this->cleaned_data);
		
		if ($this->cleaned_data['estado_nacimiento'] == 0) {
			$this->aspirante->estado_nacimiento = null;
		}
